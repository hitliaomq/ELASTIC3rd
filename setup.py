...
setup(
    ...
    package_dir = {'elastic3rd': 'src/elastic3rd', 'elastic3rd.energy' : 'src/elastic3rd/energy', 
                   'elastic3rd.symmetry' : 'src/elastic3rd/symmetry', 'elastic3rd.crystal' : 'src/elastic3rd/crystal', 
                   'elastic3rd.post' : 'src/elastic3rd/post'},
